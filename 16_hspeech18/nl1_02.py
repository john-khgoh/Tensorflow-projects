...
sampler = RandomOverSampler(sampling_strategy={0:9507,1:7000,2:5000,3:6500}) #Optimal: 9507,7000,5000,6500
...
def create_uncompiled_model():
  ...
  model = tf.keras.Sequential([
    tf.keras.layers.Embedding(VOCAB_SIZE+1,64,input_length=maxlen), #Optimal: 64,128(5),64,32,16,4
...
model.compile(loss='sparse_categorical_crossentropy', optimizer=tf.keras.optimizers.Adam(learning_rate=5e-4),
              metrics=['accuracy'])
